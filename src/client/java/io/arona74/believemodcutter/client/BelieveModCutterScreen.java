...
import io.arona74.believemodcutter.BelieveModCutterScreenHandler;
...
public class BelieveModCutterScreen extends HandledScreen<BelieveModCutterScreenHandler> {
    ...
    public BelieveModCutterScreen(BelieveModCutterScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawMouseoverTooltip(DrawContext context, int x, int y) {
        ...
        if (this.canCraft) {
            ...
            List<io.arona74.believemodcutter.BelieveModCutterRecipe> list = this.handler.getAvailableRecipes();
